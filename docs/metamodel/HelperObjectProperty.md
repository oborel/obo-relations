# Class: HelperObjectProperty
_An ObjectProperty that has is used for OWL axiomatization purposes and should not be used_
...
URI: [rometa:HelperObjectProperty](http://purl.obolibrary.org/obo/ro/ro-metamodel/HelperObjectProperty)
...
<details>
```yaml
name: HelperObjectProperty
description: An ObjectProperty that has is used for OWL axiomatization purposes and
  should not be used
