# Class: DefinedObjectPropertyByChain
_An ObjectProperty that is defined by a chain of two properties_
...
URI: [rometa:DefinedObjectPropertyByChain](http://purl.obolibrary.org/obo/ro/ro-metamodel/DefinedObjectPropertyByChain)
        ...
        * [ObjectProperty](ObjectProperty.md)
            * [DefinedObjectProperty](DefinedObjectProperty.md)
                * **DefinedObjectPropertyByChain**
                    * [DefinedObjectPropertyByChainToReflexive](DefinedObjectPropertyByChainToReflexive.md)
...
| Example | Description |
| --- | --- |
| overlaps | overlaps is defined as the chain of has-part followed by part-of |
...
<details>
```yaml
name: DefinedObjectPropertyByChain
...
attributes:
  genus:
    ...
    multivalued: false
    alias: genus
    owner: DefinedObjectPropertyByChain
