...
_An ObjectProperty that is defined by a parent property and a domain_
...
URI: [rometa:DefinedObjectPropertyByDomain](http://purl.obolibrary.org/obo/ro/ro-metamodel/DefinedObjectPropertyByDomain)
